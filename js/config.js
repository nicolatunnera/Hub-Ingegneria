...
window.i18n = {
  it: {
    ...
    docContentLabel:"Contenuto (opzionale)", dropDoc:"Trascina qui il file o clicca per selezionare (PDF, DOC, TXT, DWG, DXF, STEP, APK)", uploadDoc:"Carica Documento",
  ...
  en: {
    ...
    docContentLabel:"Content (optional)", dropDoc:"Drag file here or click to select (PDF, DOC, TXT, DWG, DXF, STEP, APK)", uploadDoc:"Upload Document",
